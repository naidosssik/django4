...
class NomineeAdmin(admin.ModelAdmin):
    list_display = ('project_name', 'user', 'nomination', 'contact', 'created_at', 'attachment', 'project_url')
    list_filter = ('nomination', 'created_at')
    search_fields = ('project_name', 'contact')
...
class VoteAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__name', 'nominee__project_name')
